<x-app-layout>
    @section('title', '- ' . __('videos.create_video'))
                                ...
                                <form action="{{ route('videos.store') }}" method="POST">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        ...
                                        <div class="w-full px-3 mt-4">
                                            ...
                                            <x-input id="week" name="week" type="number" :value="old('week') ? old('week') : $lastWeek"
                                        ...
                                        <div class="w-full px-3 mt-4">
                                            ...
                                            <x-input id="resource_url" name="resource_url" type="text" :value="old('resource_url')"
                                        ...
                                        <div class="w-full px-3 mt-4">
                                            ...
                                            <x-input id="part" name="part" type="number" :value="old('part') ? old('part') : 1"
                                        ...
                                        <div class="w-full px-3 mt-4">
                                            ...
                                            <x-input id="session_parts" name="session_parts" type="number"
                                                :value="old('session_parts') ? old('session_parts') : 1" class="w-full" min="1" max="10" />
                                            @error('session_parts')
                                                <p class="text-red-500 text-xs italic mt-4">
                                                    {{ $message }}
                                                </p>
